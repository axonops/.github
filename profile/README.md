...
At AxonOps, we are passionate supporters of open source data technologies. Our commitment extends beyond our commercial platform. We actively contribute to the open source community through projects like [AxonOps Workbench](https://github.com/axonops/axonops-workbench) (a free desktop application for Cassandra developers and DBAs) and CQLAI (an AI powered command line CQL client for Cassandra), alongside various other open source tools and contributions. We believe in empowering developers and database administrators with free, accessible tools that enhance their productivity and make working with [Apache Cassandra](https://cassandra.apache.org/), [Apache Kafka](https://kafka.apache.org/), and other open source data platforms more efficient and enjoyable.

https://github.com/user-attachments/assets/d60408a9-f19f-4112-8a42-68ea4b3d3cab
